function pintarActividades(){
    ...
    const imgUrl = window.innerWidth < 421 ? './assets/imgs/header-actividades-m.jpg?n=142' :'./assets/imgs/header-actividades.jpg?n=142';
    ...
    a.innerHTML = '';
    a.target = '_blank';
    a.href = './assets/pdf/unidad-didactica.pdf?n=142';
