function pintarHome(){
    ...
    const imgUrl = window.innerWidth < 421 ? './assets/imgs/header-home-m.jpg?n=142' : './assets/imgs/header-home.jpg?n=142';
    ...
    for(var menuObj in menu){
        ...
        let img = cE("img", divC);
        img.src = menu[menuObj].img + '?n=142';
    }
...
function pintarImgHome(parentEl){
    ...
    imgHome.src = './assets/imgs/fondo-home.jpg?n=142';
}
...
function pintarFooter(parentEl, azul){
    ...
    const imgUrl = azul ? './assets/imgs/footer.png?n=142' : './assets/imgs/footer.png?n=142' 
